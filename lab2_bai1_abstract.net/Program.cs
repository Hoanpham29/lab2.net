...
class TestProgram
{
    static void Main(string[] args)
    {
        ...
        System.Console.WriteLine("Lop Dan xuat 'GiamDoc': { 0},{ 1},{ 2},{ 3}",objGiamDoc.HoTen,objGiamDoc.Tuoi, 
        objGiamDoc.GioiTinh, objGiamDoc.ChucVu());
        KeToan objKeToan = new KeToan();
        objKeToan.HoTen = "Nguyễn Thị B";
        objKeToan.Tuoi = 26;
        objKeToan.GioiTinh = "Nữ";
        System.Console.WriteLine("Lop Dan xuat 'Ke Toan': {0}, { 1}, { 2}, { 3}",objKeToan.HoTen, objKeToan.Tuoi, 
